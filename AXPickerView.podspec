...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/devedbox/AXPickerView.git", :tag => s.version }
  ...
  s.resource  = "AXPickerView/AXPickerView/AXPickerView.bundle"
  ...
  s.dependency "AXImagePickerController"
